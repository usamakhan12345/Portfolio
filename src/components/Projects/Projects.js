        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="SMIT STORE"
              description="Full Stack e-com website if user not registerd or login then can't able to add to cart functionality. if user login or orderplaced then confirmation email sent to user."
              ghLink="https://smitstorepk.netlify.app/"
              demoLink="https://smitstorepk.netlify.app/"
            />
          </Col>
